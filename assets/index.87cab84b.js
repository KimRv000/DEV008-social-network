...
const home = (onNavigate2) => {
  ...
  sinopsis.textContent = "\xDAnete a MusiClub y deja que la m\xFAsica te conecte";
...
const register = (onNavigate2) => {
  ...
  emailInput.id = "mail";
  emailInput.placeholder = "Correo electr\xF3nico";
  emailInput.required = true;
  const passwordInput = document.createElement("input");
  passwordInput.classList.add("input");
  passwordInput.id = "contrase\xF1a1";
  passwordInput.placeholder = "Crear contrase\xF1a (al menos 8 caracteres)";
  ...
  parrafo1.textContent = "\xD3 registrate con tu cuenta";
  ...
  aceptregister.addEventListener("click", (e) => {
    ...
    const password = document.getElementById("contrase\xF1a1").value;
    crearUsuario(email, password).then((respuesta) => {
...
const login = (onNavigate2) => {
  ...
  inputContrase\u00F1a.placeholder = "Constrase\xF1a";
  ...
  textoRegistrateAqui.textContent = "Si no tienes cuenta registrate aqu\xED";
  ...
  buttonEntrar.addEventListener("click", (e) => {
    ...
    iniciarSesion(email, password).then((respuesta) => {
      const user = respuesta.user;
      console.log(user);
...
function crearPost(userAutor, userContenido, fechaHoy) {
...
const feed = (onNavigate2) => {
  ...
  function contenedorPost(post) {
    ...
    containerLike.addEventListener("click", () => {
      ...
      obtenerDocumento(post.id).then((documento) => {
    ...
    if (usuarioActual.email === post.data().autor) {
      ...
      guardarPost.addEventListener("click", () => {
        ...
        editPost(post.id, nuevoContenido).then((respuesta) => {
          publicacion.disabled = true;
      ...
      eliminarPost.addEventListener("click", () => {
        const alertConfimar = confirm("\xBFEliminar post?");
        if (alertConfimar === true) {
          borrarPost(post.id).then((respuesta) => {
            console.log(respuesta);
  ...
  buttonCerrarSesion.addEventListener("click", () => onNavigate2("/"));
  buttonPublicar.addEventListener("click", (e) => {
    ...
    crearPost(userPost, contenidoPost, fechaPost).then((respuesta) => {
